...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240919073031_006SuccessfulUponProductAPisWithoutComment")]
    partial class _006SuccessfulUponProductAPisWithoutComment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Writer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookWriter", b =>
                {
                    b.HasOne("Core.Domain.Entities.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.Writer", null)
                        .WithMany()
